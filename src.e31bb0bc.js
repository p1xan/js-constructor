...
var model = [new _blocks.TitleBlock('Конструктор сайтов на чистом JavaScript', {
  ...
  alt: 'Это картинка'
}), new _blocks.ColumnsBlock(['Это приложение написано на чистом JavaScript, без использования библиотек', 'Это конструктор сайтов', 'JavaScript - это просто, интересно. Научись создавать любые UI своими руками'], {
  styles: {
